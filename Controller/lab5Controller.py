...
class Lab5Controller:
    ...
    def start_calc(self):
        ...
        try:
            ...
            bees = BeeAlgorithm(self.function.compute, self.scout_count, self.elite_count, self.bee_in_best_count, self.bee_in_pers_count, self.dist_size, self.pers_count,
                         5, 5)
